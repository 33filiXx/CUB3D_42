...
/*   Updated: 2025/11/27 20:34:09 by wel-mjiy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_player(t_game_data *game_data, int row, int col, char orientation)
{
    t_vec2	perp;
...
int	main(int ac, char **av)
{
    ...
    mlx_put_image_to_window(game_data.mlx.mlx_connection,
        game_data.mlx.mlx_win, game_data.mlx.img, 0, 0);
